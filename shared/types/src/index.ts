...
export const roleWorkspaceMatrix: Record<UserRole, RoleWorkspaceConfig> = {
  admin: {
    homeSection: 'dashboard',
    navigationSections: ['dashboard', 'planning', 'sites', 'people', 'fleet', 'materials', 'transport', 'notifications', 'reports', 'admin'],
    apiSections: ['dashboard', 'planning', 'sites', 'people', 'fleet', 'materials', 'transport', 'notifications', 'reports', 'admin'],
  ...
  bauleiter: {
    homeSection: 'dashboard',
    navigationSections: ['dashboard', 'planning', 'sites', 'people', 'fleet', 'materials', 'transport', 'notifications', 'reports'],
    apiSections: ['dashboard', 'planning', 'sites', 'people', 'fleet', 'materials', 'transport', 'notifications', 'reports'],
    canAccessAllSites: true,
    canEditPlanning: true,
    canManageSites: true,
    canDeleteMaterials: true,
  ...
  polier: {
    ...
    navigationSections: ['planning', 'people', 'materials', 'transport', 'notifications'],
    apiSections: ['planning', 'people', 'materials', 'transport', 'notifications'],
  ...
  vorarbeiter: {
    homeSection: 'planning',
    navigationSections: ['planning', 'people', 'materials', 'notifications'],
    apiSections: ['planning', 'people', 'materials', 'notifications'],
    canAccessAllSites: false,
    canEditPlanning: true,
    canManageSites: false,
  ...
  disponent: {
    homeSection: 'transport',
    navigationSections: ['transport', 'fleet', 'planning', 'notifications', 'reports'],
    apiSections: ['transport', 'fleet', 'planning', 'notifications', 'reports'],
    canAccessAllSites: false,
  ...
  lagerist: {
    homeSection: 'materials',
    navigationSections: ['materials', 'planning', 'notifications', 'reports'],
    apiSections: ['materials', 'planning', 'notifications', 'reports'],
    canAccessAllSites: false,
    canEditPlanning: false,
    canManageSites: false,
    canDeleteMaterials: true,
  ...
  fahrer: {
    homeSection: 'fleet',
    navigationSections: ['planning', 'fleet', 'transport', 'notifications'],
    apiSections: ['planning', 'fleet', 'transport', 'notifications'],
    canAccessAllSites: false,
    canEditPlanning: false,
    canManageSites: false,
    canDeleteMaterials: false,
  ...
  worker: {
    homeSection: 'planning',
    navigationSections: ['planning', 'notifications'],
    apiSections: ['planning', 'notifications'],
    canAccessAllSites: false,
    canEditPlanning: false,
    canManageSites: false,
    canDeleteMaterials: false,
...
export function getRoleWorkspace(role: UserRole): RoleWorkspaceConfig {
  return roleWorkspaceMatrix[role];
}

export function hasSectionAccess(role: UserRole, section: PlatformSection): boolean {
  return roleWorkspaceMatrix[role].navigationSections.includes(section);
}
...
export interface DriverLoginResponse {
  accessToken: string;
  truck: { id: string; name: string; licensePlate: string };
}

export interface DriverNoteItem {
  id: string;
  licensePlate: string;
  vehicleType: string;
  driverName: string;
...
export interface CreateDriverNotePayload {
  vehicleType: string;
  driverName: string;
  fromSiteId: string;
  toSiteId: string;
